...
struct	_printer2_self
{
	char	*instance_name;
};

typedef	struct _printer2_self	printer2_self_t;

struct	_printer2_context
{
	printer2_self_t	*self;
	float			*inp_re;
	float			*inp_im;
}__attribute__((packed));

typedef struct _printer2_context	printer2_context_t;
