...
//	fft_self_t		*self = ctx->self;
	...
	float	inp_re[2048]__attribute__((aligned(32)));
	float	inp_im[2048]__attribute__((aligned(32)));
	float	out_re[2048]__attribute__((aligned(32)));
	float	out_im[2048]__attribute__((aligned(32)));
